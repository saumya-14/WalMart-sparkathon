...
const Herosection1 = () => {
  return (
    ...
    <Link href='/'>
      ...
      <Image src={left12} alt='left1.2' className='rounded-lg ' />
      ...
      <Image src={left3} alt='' className='rounded-lg  flex-grow'/>
    ...
    <Image src={right31} alt='' className='rounded-lg'/>
      ...
      <Image src={right33} alt='' className='rounded-lg mt-4 flex-grow'/>
